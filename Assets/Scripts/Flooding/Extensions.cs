...
namespace Flooding
{
    public static class Extensions
    {
        ...
        #region Vertices
        Vector3 p0 = new Vector3(-length, -1,  height);
        Vector3 p1 = new Vector3( length, -1,  height);
        Vector3 p2 = new Vector3( length, -1, -height);
        Vector3 p3 = new Vector3(-length, -1, -height);
